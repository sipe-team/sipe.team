const data = {
  ...
  qualification: {
    title: '지원 자격',
    list: [
      '관심사가 비슷한 사람들과 함께 기술을 학습하고 공유하며, 성장하고 싶으신 개발자',
      '다양한 사람들과 폭넓고 깊이 있는 네트워킹을 원하시는 개발자',
      '매주 토요일 오후 2시 ~ 6시에 진행되는 정규 활동에 성실하게 참여할 수 있으신 개발자',
    ],
  },
  event: {
    title: '행사 일정',
  ...
  makers: [
    {
      src: '/src/assets/IMG_이정민.svg',
      name: '이정민',
      role: 'Frontend Developer',
    },
    {
      src: '/src/assets/IMG_조기문.svg',
      name: '조기문',
      role: 'Frontend Developer',
    },
    {
      src: '/src/assets/IMG_이지원.svg',
      name: '이지원',
      role: 'Frontend Developer',
    },
    {
      src: '/src/assets/IMG_유현식.svg',
      name: '유현식',
      role: 'IOS Developer',
    },
    {
      src: '/src/assets/IMG_양효정.svg',
      name: '양효정',
